...
export class WorkspaceRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): WorkspaceRegistryInterface {
    return new utils.Interface(_abi) as WorkspaceRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WorkspaceRegistry {
    return new Contract(address, _abi, signerOrProvider) as WorkspaceRegistry;
  }
}
